...
if __name__ == '__main__':
    ...
    parser.add_argument('-x', '--x_label', type=str, help='the x-axis label')
    ...
    plt.xlabel(args.x_label, fontsize='large', fontweight='bold')
    plt.ylabel(args.y_label, fontsize='large', fontweight='bold')
    plt.legend()
    plt.tight_layout()
